...
AFRAME.registerComponent('multisrc', {
  ...
  materialListener: function () {
    ...
    let self = this //can't get this inside eventListener
    ...
    let animationEventsArray = ['animationbegin', 'animationstart', 'animationcomplete', 'animationend']
  ...
  styleMaterials: function () {
    ...
    let styles = this.el.components.material.material
    ...
    for (i = 0; i < this.sides; i++) {
      ...
      let a = material
      let b = styles
      let diff = AFRAME.utils.diff(a, b)
  ...
  granularChange: function (materialIndex) {
    ...
    let material = this.el.getObject3D('mesh').material[materialIndex]
    return material
  ...
  remove: function () {
    ...
    let defaultMaterial = this.el.components.material.material
